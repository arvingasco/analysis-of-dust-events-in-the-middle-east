...
plt.title(f'Altitude against Cloud Particle Concentration for {numfile} ascents/ descents in {city[0]}')     
plt.yticks(ypos, ylabels)

#plots graph
for i in range(0,1):
    #plt.scatter(actavg_cloud[i], altaxis, c = colour[i])
